...
official MSI with only the TAP-Windows driver features enabled and creates the
dedicated `WEL TAP` adapter; it does not install OpenVPN GUI or Wintun. Private
